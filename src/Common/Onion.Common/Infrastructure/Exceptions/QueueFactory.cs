...
namespace Onion.Common.Infrastructure.Extensions
{
    public static class QueueFactory
    {
        public static void SendMassageToExchange(string exchangeName, 
                                                 string exchangeType, 
                                                 string queueName, 
                                                 object obj)
        {
        ...
        {
            var factory = new ConnectionFactory() { HostName = OnionQueueConstants.RabbitMQHost };
        ...
        public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer, 
                                                           string exchangeName, 
                                                           string exchangeType = OnionQueueConstants.DefaultExchangeType)
        {
